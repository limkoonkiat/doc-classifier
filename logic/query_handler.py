...
classify_retriever_prompt = """
    ...
    Your task is to read the original text, and generate up to 5 different questions that have to be answered to give both a security and sensitivity classification. These questions should help retrieve relevant documents from a vector
